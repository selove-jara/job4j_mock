...
public class TgRun {
    ...
    public TgRun(TgAuthCallWebClint tgAuthCallWebClint, ProfileTGService profileTGService) {
        this.tgAuthCallWebClint = tgAuthCallWebClint;
        this.profileTGService = profileTGService;
    }
    ...
    public void initTg() {
        Map<String, Action> actionMap = Map.of(
                ...
                "/new", new RegAction(tgAuthCallWebClint, urlSiteAuth, profileTGService),
                "/check", new CheckAction(profileTGService),
                "/bind", new BindAction(profileTGService, tgAuthCallWebClint),
                "/unbind", new UnbindAction(profileTGService, tgAuthCallWebClint)
        );
        try {
